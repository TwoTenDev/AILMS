...
// Store the zip as a Moodle file
...
// Insert course_modules record using the real section id
$module = $DB->get_record('modules', ['name' => 'scorm'], '*', MUST_EXIST);
$cm = new stdClass();
$cm->course   = $courseid;
$cm->module   = $module->id;
$cm->instance = $scorm->id;
$cm->section  = $section->id;  // use the real section record id
$cm->visible  = 1;
$cm->added    = time();
